...
-> ( 회원 가입과 로그인에는 서버가 사용자를 인증한 후 보내주는 JWT 형식의 토큰이 응답에 포함되어야 한다)
**상품 관련 기능**
- 상품 등록
- 상품 내용 수정
- 상품 삭제
...
https://www.notion.so/691e80f9e9fd4526b8b9a8f6eb0e1888?v=11579d7479f847d984825d39918ad466&pvs=4
